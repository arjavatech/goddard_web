...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-10 w-full bg-transparent py-3 text-sm placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 !border-0 !ring-0 !outline-none focus:!border-0 focus:!ring-0 focus-visible:!ring-0 focus-visible:!outline-none !shadow-none rounded-none",
        className
      )}
      {...props}
    />
