import { BookOpen, ClipboardList, Bell, FileText, HelpCircle, UserCheck } from 'lucide-react';
...
const staticSections = [
  {
    ...
    items: [
      'Log in to the Employee Portal using your registered email and password.',
      'Your dashboard shows all forms assigned to you and your overall completion progress.',
      'Use the card or table view toggle to switch how your forms are displayed.',
    ],
  },
  {
    icon: ClipboardList,
    title: 'Completing Assigned Forms',
    items: [
      'Navigate to "Assigned Forms" to see all forms assigned to you.',
      'Click on any form card or the eye icon to open and fill out a form.',
      'Forms are saved automatically — you can return and complete them later.',
      'Once submitted, the form status will update to "Submitted" or "Approved".',
    ],
  },
  {
    icon: FileText,
...
export function EmployeeGuideContent() {
    ...
    <div className="space-y-5">
      <div className="flex items-center gap-3 p-3 rounded-lg bg-amazon-teal/5 border border-amazon-teal/20">
        ...
        <p className="text-sm text-slate-500">
          This guide walks you through everything you need to complete your assigned forms at The Goddard School.
        </p>
      </div>
