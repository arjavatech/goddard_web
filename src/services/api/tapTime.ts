...
export type AttendanceReport = { emp_id?: string; name?: string; email?: string; pin?: string; date?: string; check_in_time?: string; check_out_time?: string; time_worked?: string; type?: string; last_modified_by?: string; check_in_snap?: string; check_out_snap?: string };
